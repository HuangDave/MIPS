...
module EXECUTE (
    ...
    input      [4:0] i_rs, i_rt, i_rf_wa,     [31:0] i_rf_rd1, i_rf_rd2, i_shamt, i_sext_imm, i_pc_plus4,
    output reg [4:0] o_rs, o_rt, o_rf_wa, reg [31:0] o_rf_rd1, o_rf_rd2, o_shamt, o_sext_imm, o_pc_plus4 );
...
module WRITEBACK (
    ...
    input      [4:0] i_rf_wa,     [31:0] i_alu_out, i_rd_dm, i_pc_plus4,
    output reg [4:0] o_rf_wa, reg [31:0] o_alu_out, o_rd_dm, o_pc_plus4 );

...
module EXECUTE (
    input            clk, rst,
    input            i_jal, i_alu_src, i_shift, i_we_hi_lo, i_we_dm, i_rf_we, i_dm2reg,     [1:0] i_res2reg, i_pc_src,     [2:0] i_alu_ctrl,
    output reg       o_jal, o_alu_src, o_shift, o_we_hi_lo, o_we_dm, o_rf_we, o_dm2reg, reg [1:0] o_res2reg, o_pc_src, reg [2:0] o_alu_ctrl,
...
module MEMORY (
    input            clk, rst,
    input            i_jal, i_we_hi_lo, i_we_dm, i_rf_we, i_dm2reg,     [1:0] i_res2reg,
    output reg       o_jal, o_we_hi_lo, o_we_dm, o_rf_we, o_dm2reg, reg [1:0] o_res2reg,
...
module WRITEBACK (
    input            clk,
    input            i_jal, i_rf_we, i_dm2reg,      [1:0] i_res2reg,
    output reg       o_jal, o_rf_we, o_dm2reg, reg [1:0] o_res2reg,

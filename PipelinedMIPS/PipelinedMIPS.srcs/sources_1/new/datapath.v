...
// debugs
    ...
    mul     mul         ( .clk(clk), .rst(flush_E), .a(rf_rd1_D), .b(rf_rd2_D), .hi(mul_hi_out_M), .lo(mul_lo_out_M) ); // 2-stage pipelined mul, hi and lo ready at WRITEBACK
    ...
    wire        jal_M, we_hi_lo_M, we_dm_M, dm2reg_M;
    wire [1:0]  res2reg_M;

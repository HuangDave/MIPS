...
module datapath (
    ...
    wire [1:0]  res2reg_E;
    wire [2:0]  alu_ctrl_E;
    wire [31:0] rf_rd1_E, rf_rd2_E, shamt_E, sext_imm_E, alu_srcA_pre_E, alu_srcA_E, alu_srcB_E, dm_wd_E, pc_plus8_E;
    ...
    mux4 mul_fwdB_mux   ( .sel(mul_fwdA_D), .a(rf_rd1_D), .b(rf_wd_W), .c(alu_out_M), .d(dm_rd_M), .y(mul_srcA_D) );

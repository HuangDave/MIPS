...
module MIPS(
    ...
    wire [1:0] pc_src_E, fwdA_E, fwdB_E;
    ...
    datapath        dp ( .clk(clk), .rst(rst),
                         ...
                         .stall_F(stall_F), .stall_D(stall_D), .flush_D(flush_D), .flush_E(flush_E), .fwd_br(fwd_br), .fwdA_E(fwdA_E), .fwdB_E(fwdB_E),
                         .dm2reg_E(dm2reg_E), .rf_we_E(rf_we_E), .rf_we_M(rf_we_M), .rf_we_W(rf_we_W), .pc_src_E(pc_src_E),

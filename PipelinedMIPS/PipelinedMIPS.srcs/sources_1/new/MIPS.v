...
module MIPS(
    ...
    wire [1:0] pc_src_E, br_fwdA_D, br_fwdB_D, mul_fwdA, mul_fwdB, fwdA_E, fwdB_E;
    ...
    datapath        dp ( .clk(clk), .rst(rst),
                         ...
                         .br_fwdA_D(br_fwdA_D), .br_fwdB_D(br_fwdB_D), .mul_fwdA(mul_fwdA),.mul_fwdB(mul_fwdB), .fwdA_E(fwdA_E), .fwdB_E(fwdB_E),

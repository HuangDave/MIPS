...
module datapath (
    input  wire        clk, rst,
    input  wire [4:0]  rf_ra3,
    input  wire        branch_D, jump_D, jal_D, jr_D, r_type_D, alu_src_D, shift_D, we_hi_lo_D, we_dm_D, rf_we_D, dm2reg_D, [1:0] res2reg_D, [2:0] alu_ctrl_D,
    output wire [31:0] instr_D,
    output wire [31:0] pc_current, instr, rf_rd3,

    input  wire        wem_M,                            // input and outputs for SoC
    input  wire [31:0] soc_rd_M,
    output wire        we_dm_M,
    output wire [31:0] address_M, dm_rd_M, dm_wd_M );

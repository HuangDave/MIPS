...
HD_PWD='C:/Users/huang/Documents/School/CMPE140/SingleCycleMIPS/SingleCycleMIPS.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SoC_fpga.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SoC_fpga.tcl -notrace
